...
The mean number of steps is `r mean_steps` and the median is `r med_steps`.
...
On average, interval `r max_steps` contains the maximum number of steps.
...
The mean number of steps is `r mean_stepsnona` compared with `r mean_steps` before.

The median is `r med_stepsnona` compared with `r med_steps` before.
